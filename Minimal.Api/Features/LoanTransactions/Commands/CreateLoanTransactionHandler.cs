...
public class CreateLoanTransactionHandler : IRequestHandler<CreateLoanTransaction, LoanTransactionGetDto>
{
    ...
    public CreateLoanTransactionHandler(ApplicationDbContext context, IMapper mapper, IStringLocalizer<SharedResource> localizer)
    {
    ...
    public async Task<LoanTransactionGetDto> Handle(CreateLoanTransaction request, CancellationToken cancellationToken)
    {
        ...
        var documentToAdd = new Document
        {
            ...
            DocumentType = await _context.DocumentTypes.SingleAsync(at => at.Code == "21", cancellationToken),
        ...
        return _mapper.Map<LoanTransactionGetDto>(documentToAdd);
    }
}